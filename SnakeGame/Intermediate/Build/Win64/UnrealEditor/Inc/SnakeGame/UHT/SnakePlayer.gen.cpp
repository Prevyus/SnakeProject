...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ASnakePlayer_Statics::NewProp_Collider = { "Collider", nullptr, (EPropertyFlags)0x01440000000a001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ASnakePlayer, Collider), Z_Construct_UClass_USphereComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Collider_MetaData), NewProp_Collider_MetaData) };
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_santi_OneDrive_Escritorio_Github_SnakeProject_SnakeGame_Source_SnakeGame_SnakePlayer_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ASnakePlayer, ASnakePlayer::StaticClass, TEXT("ASnakePlayer"), &Z_Registration_Info_UClass_ASnakePlayer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASnakePlayer), 805178833U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_santi_OneDrive_Escritorio_Github_SnakeProject_SnakeGame_Source_SnakeGame_SnakePlayer_h_1543589856(TEXT("/Script/SnakeGame"),
	Z_CompiledInDeferFile_FID_Users_santi_OneDrive_Escritorio_Github_SnakeProject_SnakeGame_Source_SnakeGame_SnakePlayer_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_santi_OneDrive_Escritorio_Github_SnakeProject_SnakeGame_Source_SnakeGame_SnakePlayer_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
